...
/**
 * class Admin__get_not_admin_users | file admin__get_not_admin_users.php
 *
 ...
 * @subpackage admin__get_not_admin_users
 * @author @AfpaLabTeam - Damien
 * @copyright  1920-2080 Afpa Lab Team - CDA 20303
 * @version v1.0
 */
class Admin__get_not_admin_users	{
    ...
    private function main() {
        ...
        $aNotAdminUsers = $objet_service->getNotAdminUsers();
        send_json_to_JS($aNotAdminUsers);
