...
/**
 * class Admin__get_admins_infos | file admin__get_admins_infos.php
 *
 ...
 * @subpackage admin__get_admins_infos
 * @author @AfpaLabTeam - Damien
 * @copyright  1920-2080 Afpa Lab Team - CDA 20303
 * @version v1.0
 */
class Admin__get_admins_infos	{
    ...
    private function main() {
        ...
        $aAdminsInfos = $objet_service->getAdminsInfos();
        send_json_to_JS($aAdminsInfos);
