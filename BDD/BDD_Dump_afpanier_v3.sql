...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 05 jan. 2021 à 13:23
...
INSERT INTO `basket` (`id_basket`, `id_supplier`, `id_mainBasket`, `basket_name`, `basket_image`, `basket_description`, `basket_reference`, `basket_price`, `basket_status`) VALUES
(1, 5, 4, 'Mon beau panier', 'panier.png', 'assortiment de fruits et légumes d\'hiver', 'BASK_WIN_584690', '10.50', 1),
(2, 1, 4, 'Panier de fruits', 'panier_2.png', 'Toute une selection de fruits de saison pour vous', 'BASK_WIN_458470', '9.99', 0),
(3, 2, 1, 'Panier de Legumes', 'vin.png', 'Toute une selection de légumes de saison pour vous', 'BASK_SPR_842540', '13.50', 1),
(4, 6, 1, 'Panier gourmand', 'noel.jpg', 'panier gourmand à partager…ou pas', 'BASK_SPR_325890', '12.99', 1);
...
CREATE TABLE IF NOT EXISTS `mainbasket` (
  ...
  `mainBasket_begin_date` datetime NOT NULL,
  `mainBasket_end_date` datetime NOT NULL,
  `mainBasket_payment_begin_date` datetime NOT NULL,
  `mainBasket_payment_end_date` datetime NOT NULL,
  `mainBasket_withdrawal_begin_date` datetime NOT NULL,
  `mainBasket_withdrawal_end_date` datetime NOT NULL,
  `mainBasket_validation_begin_date` datetime NOT NULL,
  `mainBasket_validation_end_date` datetime NOT NULL,
...
INSERT INTO `mainbasket` (`id_mainBasket`, `mainBasket_name`, `mainBasket_begin_date`, `mainBasket_end_date`, `mainBasket_payment_begin_date`, `mainBasket_payment_end_date`, `mainBasket_withdrawal_begin_date`, `mainBasket_withdrawal_end_date`, `mainBasket_validation_begin_date`, `mainBasket_validation_end_date`, `mainBasket_status`) VALUES
(1, 'Spring', '2020-12-15 08:00:00', '2020-12-20 17:00:00', '2020-12-17 08:00:00', '2020-12-22 17:00:00', '2020-12-21 08:00:00', '2020-12-15 17:00:00', '2020-12-15 08:00:00', '2020-12-22 17:00:00', 1),
(2, 'Summer', '2020-12-28 08:00:00', '2021-01-04 17:00:00', '2021-01-01 08:00:00', '2021-01-03 17:00:00', '2021-01-03 08:00:00', '2021-01-06 17:00:00', '2020-12-28 08:00:00', '2020-01-06 17:00:00', 0),
(3, 'Fall', '2021-03-17 08:00:00', '2021-03-22 17:00:00', '2021-03-21 08:00:00', '2021-03-23 17:00:00', '2021-03-23 08:00:00', '2021-03-25 17:00:00', '2020-03-17 08:00:00', '2020-03-25 17:00:00', 0),
(4, 'Winter', '2020-12-15 08:00:00', '2021-03-21 08:00:00', '2021-03-27 17:00:00', '2021-03-26 08:00:00', '2021-03-28 17:00:00', '2021-03-27 08:00:00', '2020-12-15 08:00:00', '2021-03-27 08:00:00', 1);
...
CREATE TABLE IF NOT EXISTS `purchase` (
  ...
  `purchase_reservationNotif_read` tinyint(1) DEFAULT 0,
  `purchase_paymentNotif_read` tinyint(1) DEFAULT 0,
  `purchase_withdrawal_read` tinyint(1) DEFAULT 0,
...
(5, 1, '2020-12-27 13:39:09', 'FQN4QHQDL1', 0, 0, 0, 1),
(6, 1, '2020-12-27 13:47:27', 'IZSP4LQVN8', 0, 0, 0, 1),
(8, 1, '2021-01-01 10:17:08', 'TYOSCL8VFJ', 0, 0, 0, 1),
(9, 1, '2021-01-01 14:31:28', 'ZFT266B2V2', 0, 0, 0, 1);
