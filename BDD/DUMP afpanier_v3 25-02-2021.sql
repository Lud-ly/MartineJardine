...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 25 fév. 2021 à 14:05
...
(2, 5, 4, 'Panier de fruits', 'panier_2.png', 'Toute une selection de fruits de saison pour vous', 'BASK_WIN_458470', 17, 20, '9.99', '2020-12-28 08:00:00', '2021-01-04 17:00:00', NULL, NULL, '2021-01-01 08:00:00', '2021-01-03 17:00:00', '2021-01-03 08:00:00', '2021-01-06 17:00:00', 0),
...
CREATE TABLE `center` (
  ...
  `center_training_schedule` varchar(255) NOT NULL,
...
INSERT INTO `center` (`id_center`, `center_name`, `center_phoneNumber`, `center_address`, `center_complement_address`, `center_zipCode`, `center_city`, `center_schedule`, `center_training_schedule`, `center_contact_mail`, `center_withdrawal_place`, `center_withdrawal_schedule`, `center_urlGoogleMap`) VALUES
(1, 'AFPA Saint-Jean-de-Védas', '04.67.98.56.32', '12 rue Jean Mermoz', 'Zone Industriel de La Lauze', '34430', 'Saint-Jean-de-Védas', 'Horaire de 8h00 à 16h00 du lundi au vendredi', 'Tous le mercredis : Le matin de 9h00 à 11h00', 'afpa.vedas@contact.com', 'Bat 14', 'Jeudi de 12h00 à 14H00', 'https://www.google.com/maps/dir/43.6007954,3.8757129/afpa+saint+jean+de+vedas/@43.5814544,3.8471799,14z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x12b6b1e78790b019:0x5fe2ea1bc7b758d9!2m2!1d3.8450793!2d43.5645741'),
...
(7, 'Mon beau panier 100', 'mainBasket_19_02_21.jpg', 'Mon meilleur panier', 1),
(8, 'Mon beau panier 50', 'mainBasket_19_02_18.jpg', 'vftèfèg_çgçgç', 1),
(9, 'cfgy', '', '', 1),
(10, 'vgu', '', '', 1),
(11, 'Mon beau panier 72', 'mainBasket_19_02_42.jpg', 'guvygfu', 1),
(12, 'Mon beau panier 75', 'mainBasket_19_02_47.jpg', 'jguhvu', 1);
...
(1, 1, 'crcdValidation', 1, 1),
(2, 1, 'validationTime', 72, 1),
(3, 1, 'paymentTime', 96, 1),
(4, 1, 'recoveryTime', 96, 1);
...
(3, 1, '2020-12-01 17:00:00', 'CUT10', 1, 1, 1, 5),
(4, 1, '2020-12-03 16:00:00', 'NO30', 1, 1, 1, 6),
...
(1, 0, 1, 'Pagan', 'Jean-Jacques', 'pagan.jijou@gmail.com', '2154987654', '0636231456', 'Poos654654usnks', 4, '2021-02-25 13:09:53', 'BDL398', 1, 1),
(2, 0, 1, 'Hautefeuille', 'Ludovic', 'hautefeuille.ludo@orange.com', '98765431', '0658961235', 'HdhghdJ654OIUlkj', 1, '2021-02-24 11:15:09', 'DTHD65', 1, 1),
...
(7, 0, 1, 'Moreno', 'Antoine', 'antoine-moreno34@hotmail.fr', '1234567', '0613845761', 'aaaa', 0, '2021-02-24 15:32:23', '', 1, 1);
...
--
ALTER TABLE `mainbasket`
  MODIFY `id_mainBasket` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT pour la table `measureunit`
--
ALTER TABLE `measureunit`
  MODIFY `id_measureUnit` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `purchase`
  MODIFY `id_purchase` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
